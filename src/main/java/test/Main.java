...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            throw new IllegalArgumentException("[ERR] " + browser + " is not supported, we covered for "
        ...
        for (int groupIndex = 0; groupIndex < testGroupNames.size(); groupIndex++) {
            ...
            int endIndex = groupIndex == testGroupNames.size() - 1
                    ? testsClasses.size() : (startIndex + testNumEachGroup);
