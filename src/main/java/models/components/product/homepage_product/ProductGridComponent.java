...
public class ProductGridComponent extends Component {
    ...
    public List<ProductItemComponent> productItemComps() {
        return findComponents(driver, ProductItemComponent.class);
    }
    public ProductItemComponent firstProductItemComp() {
        return findComponent(driver, ProductItemComponent.class);
    }
}
